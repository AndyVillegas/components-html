(function (window, document) {
    const AdapTable = function ({ id, nowrap }) {
        // begin constants
        ...
        (function () {
            ...
            if (nowrap)
                $table.classList.add('table-responsive--nowrap');
        })()
    ...
    if (typeof window.AdapTable === 'undefined') {
        window.AdapTable = AdapTable;
    } else {
        console.error('AdapTable ya fue cargado');
    }
})(window, document);